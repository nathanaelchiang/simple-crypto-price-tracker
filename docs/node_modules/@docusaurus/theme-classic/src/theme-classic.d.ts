...
declare module '@theme/Footer/Logo' {
  ...
  import type {FooterLogo} from '../../theme-common/src';
...
declare module '@theme/Footer/LinkItem' {
  ...
  import type {FooterLinkItem} from '../../theme-common/src';
...
declare module '@theme/Footer/Links' {
  import type {ReactNode} from 'react';
  import type {Footer} from '../../theme-common/src';
...
declare module '@theme/Footer/Links/MultiColumn' {
  import type {ReactNode} from 'react';
  import type {MultiColumnFooter} from '../../theme-common/src';
...
declare module '@theme/Footer/Links/Simple' {
  import type {ReactNode} from 'react';
  import type {SimpleFooter} from '../../theme-common/src';
...
declare module '@theme/TabItem' {
  ...
  import type {TabItemProps} from '../../theme-common/src/internal';
...
declare module '@theme/Tabs' {
  import type {ReactNode} from 'react';
  import type {TabsProps} from '../../theme-common/src/internal';
...
declare module '@theme/Details' {
  import {Details, type DetailsProps} from '../../theme-common/src/components/Details';
...
declare module '@theme/TOCItems' {
  import type {ReactNode} from 'react';
  import type {TOCItem} from '@docusaurus/mdx-loader/src';
...
declare module '@theme/TOCItems/Tree' {
  import type {ReactNode} from 'react';
  import type {TOCTreeNode} from '../../theme-common/src/internal';
...
declare module '@theme/ColorModeToggle' {
  import type {ReactNode} from 'react';
  import type {ColorMode} from '../../theme-common/src';
...
declare module '@theme/TagsListByLetter' {
  import type {ReactNode} from 'react';
  import type {TagsListItem} from '@docusaurus/utils/src';
...
declare module '@theme/TagsListInline' {
  import type {ReactNode} from 'react';
  import type {Tag} from '@docusaurus/utils/src';
