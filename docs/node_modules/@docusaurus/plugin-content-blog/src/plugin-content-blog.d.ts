...
declare module '@docusaurus/plugin-content-blog' {
  import type {LoadedMDXContent} from '@docusaurus/mdx-loader/src';
  import type {MDXOptions} from '@docusaurus/mdx-loader/src';
  import type {
    FrontMatterTag,
    TagMetadata,
    LastUpdateData,
...
declare module '@theme/BlogTagsPostsPage' {
  ...
  import type {TagModule} from '@docusaurus/utils/src';
