...
import {toValue} from '@docusaurus/mdx-loader/src/remark/utils';
...
export async function createTOCExportNodeAST({
  ...
  async function createTOCHeadingAST({heading}: TOCHeading) {
    ...
    const {valueToEstree} = await import('../../../../../estree-util-value-to-estree/src/estree-util-value-to-estree');
    const value: TOCItem = {
